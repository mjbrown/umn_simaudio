# 
# Project automation script for umn_simaudio 
# 
# Created for ISE version 13.4
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source umn_simaudio.tcl), then you can
...
set myProject "umn_simaudio"
set myScript "umn_simaudio.tcl"
...
proc add_source_files {} {
   ...
   xfile add "ipcore_dir/fastclock.xaw"
   xfile add "src/DPIMREF.vhd"
   xfile add "src/main.v"
   xfile add "tc_main.v"
   puts ""
